        ...
        return (
            ...
            est, qui dolorem ipsum quia dolor sit amet, consectetur</p>
                                <ul className="contact-list">
                                    <li> <i className="fa fa-map-marker" aria-hidden="true" /> Raiya Chowk ,Rajkot, India.</li>
                                    <li><i className="fa fa-envelope" aria-hidden="true" /><Link to="/gmail.com">parthtrivedi0710@gmail.com</Link></li>
                                    <li> <i className="fa fa-phone" aria-hidden="true" />+91 9898558644</li>
                                </ul>
                                <div id="container">
                                    {/*Horizontal Tab*/}
                                        ...
                                        <div className="resp-tabs-container hor_1">
                                            ...
                                            <div>
                                                <div className="map-grid">
                                                    <h5>Our Branches</h5>
                                                    <ul>
                                                        <li><i className="fa fa-arrow-right" aria-hidden="true" />Raiya Chowk, Rajkot, India.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div>
                                                <div className="map-grid">
                                                    ...
                                                    <ul>
                                                        <li>Mobile No : +91 7016055098</li>
                                                        <li>Phone No : +91 7041709259</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
